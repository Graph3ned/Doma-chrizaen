...
const form1 = document.forms['enterName'];
    const hiddenButton = document.getElementById('continue');
...
document.getElementById('continue').addEventListener('click', function() {
    ...
    const input2Value = document.getElementById('section').value;
    
    // Set the value of the second input to the value of the first input
    document.getElementById('firstName').value = input1Value;
    document.getElementById('section2').value = input2Value;
});
continue_btn.onclick = ()=>{
    document.getElementById("submitButtons").click();
    info_box.classList.remove("activeInfo"); //hide info box
...
function showResult(){
    ...
    //  sendDataToGoogleSheets(userScore);
...
//         const scriptURL = 'https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec'; // Replace YOUR_SCRIPT_ID with your actual script ID
//         const data = {
//             name: "User", // You can replace this with dynamic user data if available
//             score: score
//         };
...
// // Add the event listener within the function
// function initializeFormListener() {
//   form.addEventListener('submit', submitForm);
// }

// Call this function when you want to set up the form submission behavior